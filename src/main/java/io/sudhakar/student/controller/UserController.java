...
public class UserController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<StudentResponse<UserDetails>> getUser(@PathVariable int id) {
        log.info("api = /user, method = GET, result = IN_PROGRESS");
    ...
    @PutMapping("/{id}")
    public ResponseEntity<StudentResponse<Void>> updateUser(@RequestBody UserDetails userDetails,@PathVariable int id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<StudentResponse<Void>> deleteUser(@PathVariable int id) {
